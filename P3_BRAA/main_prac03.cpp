...
/*--------------------- Instructivo: ----------------------*/
/*
Con las teclas del teclado se pueden mover las letras simultáneamente.
...
void display(void)
{
	...
	//Se dibuja el segundo cubo
	model = glm::translate(model, glm::vec3(1.0f, 0.0f, 0.0f) );
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24);

	//Nota: cualquier transformación realizada sobre la matriz "model" es acumulativo a las siguientes transformaciones.

	//Se dibujan todos los demás cubos
