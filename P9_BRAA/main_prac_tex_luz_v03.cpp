...
/*---------------------------------- Instructivo: ----------------------------------*/
/*
Con las teclas del teclado se puede mover todo el modelo:
...
unsigned int t_panda;
unsigned int t_cubo;
unsigned int t_caja;
unsigned int t_caja_brillo;
unsigned int t_ladrillos;
unsigned int t_negro;
unsigned int t_erizo;
unsigned int t_perrito;
unsigned int t_erizo_brillo;
unsigned int t_perrito_brillo;
...
void LoadTextures()
{
	...
	t_panda = generateTextures("Texturas/Panda.jpg", 0);
	...
	t_negro = generateTextures("Texturas/textura_negro.jpg", 0);
	t_erizo = generateTextures("Texturas/Erizo.jpg", 0);
	t_perrito = generateTextures("Texturas/Perrito.jpg", 0);
	t_erizo_brillo = generateTextures("Texturas/Erizo_Specular.png", 1);
	t_perrito_brillo = generateTextures("Texturas/Perrito_Specular.png", 1);
	...
	glBindTexture(GL_TEXTURE_2D, t_erizo);
	glActiveTexture(GL_TEXTURE12);
	glBindTexture(GL_TEXTURE_2D, t_perrito);
	glActiveTexture(GL_TEXTURE13);
	glBindTexture(GL_TEXTURE_2D, t_erizo_brillo);
	glActiveTexture(GL_TEXTURE14);
	glBindTexture(GL_TEXTURE_2D, t_perrito_brillo);
}
...
void display(void)
{
	...
	//Se establecen las componentes de iluminación
	...
	//Caja 1 (Caja hecha con las coordenadas de Caja 1 de Vertices)
	lightingShader.setInt("material_diffuse", t_unam);
	lightingShader.setInt("material_specular", t_caja_brillo);
	glDrawArrays(GL_QUADS, 0, 24);

	//Caja 2 (Caja hecha con las coordenadas de Caja 1 de Vertices)
	...
	//Caja 3 (Caja hecha con las coordenadas de Caja 1 de Vertices)
	...
	//Caja 4 (Caja hecha con las coordenadas de Caja 2 de Vertices)
	...
	lightingShader.setInt("material_specular", t_erizo_brillo);
	...
	model = glm::scale(model, glm::vec3(1.25f, 1.25f, 1.25f));
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_diffuse", t_perrito);
	lightingShader.setInt("material_specular", t_perrito_brillo);
	...
	model = glm::scale(model, glm::vec3(1.25f, 1.25f, 1.25f));
	lightingShader.setMat4("model", model);
	lightingShader.setInt("material_diffuse", t_ladrillos);
	lightingShader.setInt("material_specular", t_negro);
